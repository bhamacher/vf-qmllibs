...
Item {
    ...
    readonly property string fa_airbnb
    : "\uf834";
    ...
    readonly property string fa_balance_scale_left
    : "\uf515";

    readonly property string fa_balance_scale_right
    : "\uf516";
    ...
    readonly property string fa_battle_net
    : "\uf835";
    ...
    readonly property string fa_biking
    : "\uf84a";
    ...
    readonly property string fa_bootstrap
    : "\uf836";
    ...
    readonly property string fa_border_style
    : "\uf853";
    ...
    readonly property string fa_buffer
    : "\uf837";
    ...
    readonly property string fa_buy_n_large
    : "\uf8a6";
    ...
    readonly property string fa_chromecast
    : "\uf838";
    ...
    readonly property string fa_compress_alt
    : "\uf422";
    ...
    readonly property string fa_cotton_bureau
    : "\uf89e";
    ...
    readonly property string fa_dailymotion
    : "\e052";
    ...
    readonly property string fa_deezer
    : "\e077";
    ...
    readonly property string fa_edge_legacy
    : "\e078";
    ...
    readonly property string fa_evernote
    : "\uf839";
    ...
    readonly property string fa_expand_alt
    : "\uf424";
    ...
    readonly property string fa_firefox_browser
    : "\e007";
    ...
    readonly property string fa_git_alt
    : "\uf841";
    ...
    readonly property string fa_google_pay
    : "\e079";
    ...
    readonly property string fa_hand_holding_water
    : "\uf4c1";
    ...
    readonly property string fa_hands_wash
    : "\e05e";

    readonly property string fa_handshake
    : "\uf2b5";

    readonly property string fa_handshake_alt_slash
    : "\e05f";
    ...
    readonly property string fa_ideal
    : "\e013";
    ...
    readonly property string fa_instagram_square
    : "\e055";
    ...
    readonly property string fa_itch_io
    : "\uf83a";
    ...
    readonly property string fa_laptop_house
    : "\e066";
    ...
    readonly property string fa_mdb
    : "\uf8ca";
    ...
    readonly property string fa_microblog
    : "\e01a";
    ...
    readonly property string fa_mixer
    : "\e056";
    ...
    readonly property string fa_mouse
    : "\uf8cc";
    ...
    readonly property string fa_orcid
    : "\uf8d2";
    ...
    readonly property string fa_phone_alt
    : "\uf879";
    ...
    readonly property string fa_phone_square_alt
    : "\uf87b";

    readonly property string fa_phone_volume
    : "\uf2a0";

    readonly property string fa_photo_video
    : "\uf87c";
    ...
    readonly property string fa_remove_format
    : "\uf87d";
    ...
    readonly property string fa_rust
    : "\e07a";
    ...
    readonly property string fa_salesforce
    : "\uf83b";
    ...
    readonly property string fa_shopify
    : "\e057";
    ...
    readonly property string fa_sort_alpha_down_alt
    : "\uf881";

    readonly property string fa_sort_alpha_up
    : "\uf15e";

    readonly property string fa_sort_alpha_up_alt
    : "\uf882";

    readonly property string fa_sort_amount_down
    : "\uf160";

    readonly property string fa_sort_amount_down_alt
    : "\uf884";

    readonly property string fa_sort_amount_up
    : "\uf161";

    readonly property string fa_sort_amount_up_alt
    : "\uf885";
    ...
    readonly property string fa_sort_numeric_down_alt
    : "\uf886";

    readonly property string fa_sort_numeric_up
    : "\uf163";

    readonly property string fa_sort_numeric_up_alt
    : "\uf887";
    ...
    readonly property string fa_speaker_deck
    : "\uf83c";
    ...
    readonly property string fa_stackpath
    : "\uf842";
    ...
    readonly property string fa_store_alt_slash
    : "\e070";
    ...
    readonly property string fa_swift
    : "\uf8e1";
    ...
    readonly property string fa_symfony
    : "\uf83d";
    ...
    readonly property string fa_tiktok
    : "\e07b";
    ...
    readonly property string fa_umbraco
    : "\uf8e8";
    ...
    readonly property string fa_unity
    : "\e049";
    ...
    readonly property string fa_unsplash
    : "\e07c";
    ...
    readonly property string fa_waze
    : "\uf83f";
    ...
    readonly property string fa_yammer
    : "\uf840";
